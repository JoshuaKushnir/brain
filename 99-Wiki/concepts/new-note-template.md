...
aliases:
  - "NNT"
  - "Nightfall Documentation Template"
  - "Entity Template"
---
...
- **Standardization**: Provides a uniform structure for all project documentation.
- **Canon Tracking**: Requires creators to define and declare the canon status of specific information.
- **Contextual Integration**: mandates the inclusion of historical context and links to foundational world-building elements.
- **Cross-Disciplinary Bridge**: Connects narrative lore with functional gameplay mechanics.
- **Knowledge Organization**: Designed to help resolve open questions and manage evolving project data.
...
- "# Entity Template" — [[03-projects/Nightfall/05-Design/Templates/Entity Template|Entity Template]]
