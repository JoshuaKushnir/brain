...
- [[entities/nightfall|nightfall]] `aliases: Nightfall Project, The Nightfall, The Great Cataclysm, Pre-Nightfall, Post-Nightfall` - Nightfall is a project initiative encompassing both a documented world-building vault and an associa
...
- [[entities/lamp|lamp]] `aliases: The Lamp, Patron God Lamp, Deity of Illumination, Covenantal Lamp, Lamp of the Nightfall` - Lamp is one of the twelve **Patron Gods** who participated in the survival covenants that forged the
...
- [[entities/hearth|hearth]] `aliases: Hearth Region, The Hearth God, God of Hearth, Hearthland, Origin of the Covenants, The Hearth Pantheon` - Hearth serves a dual function as both one of the twelve [[concepts/patron-gods|Patron Gods]] and a s
...
- [[concepts/proposal|proposal]] `aliases: Draft, Unresolved Material` - Proposal identifies content within the [[entities/nightfall]] project that has not yet been verified
...
- [[concepts/new-note-template|new-note-template]] `aliases: NNT, Nightfall Documentation Template, Entity Template` - The New Note Template is a standardized documentation framework developed for the [[entities/nightfa
...
- [[concepts/marrow|marrow]] `aliases: Forbidden Bodily Aspect` - Marrow is a forbidden [[concepts/aspects|aspects]] associated with the concept of bodily authorship.
...
- [[sources/patron-gods_29832d|patron-gods_29832d]] `aliases: Twelve Patron Gods, The Patron Gods Overview`
