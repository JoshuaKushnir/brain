...
Builds on the confirmed Ring order (Timeline.md, Naming Canon): Center = [[Vigil]]/[[The Rise]], First = [[03-projects/Nightfall/02-World/Geography/Hearth]], Second = [[Gloam]], Third = [[Murk]], Fourth = [[Night]], Fifth = [[The Rim]], Beyond = [[The Dark]].
